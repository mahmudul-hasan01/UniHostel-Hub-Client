...
const MemberCart = ({ items, price }) => {
    return (
        <div className="md:w-[300px] mx-auto space-y-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] my-20 relative p-8">
            {/* top part  */}
            <div>
                <img className="w-[60px] border h-[60px] object-cover rounded-full p-2 bg-slate-100 duration-300 hover:scale-105" src={items} alt="card navigate ui"
                />
                {/* Price Ribbon SVG  */}
